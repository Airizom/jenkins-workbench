...
- feat: add pipeline node log selection and export in build details

### Changed

- refactor: consolidate duplicate helpers across panels and services

## [1.47.0] - 2026-05-03

### Added

- feat: add node capacity panel and queued-work insights

## [1.46.0] - 2026-05-03

### Added

- feat: add browser SSO sign-in and reauth flow
...
- feat: add build compare panel for completed builds

## [1.43.0] - 2026-04-15

### Added

- feat: add build coverage summary and coverage decorations

## [1.42.0] - 2026-04-14

### Added

- feat: add workspace browsing and file preview

## [1.41.0] - 2026-04-14

### Added

- feat: add build details pipeline graph view

## [1.40.0] - 2026-04-13

### Added

- feat: add build details test results tab and source navigation
...
- feat: add editable replay drafts for Jenkins builds

### Changed

- chore: ignore .pi/settings.json
...
- feat: preserve tree expansion state during refresh

## [1.28.0] - 2026-02-02

### Added

- feat: add node offline/online actions and agent launch flow
