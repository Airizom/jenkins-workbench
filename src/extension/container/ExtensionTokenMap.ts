...
import type { JenkinsfileValidationStateStore } from "../../validation/JenkinsfileValidationStateStore";
...
export interface ExtensionTokenMap {
  ...
  jenkinsfileValidationStateStore: JenkinsfileValidationStateStore;
